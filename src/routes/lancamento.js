...
const lancamentoValidation = [
  ...
  body('receitaId').optional().isInt().withMessage('ID da receita deve ser um número inteiro'),
  body('centroDeCustoId').optional().isInt().withMessage('ID do centro de custo deve ser um número inteiro')
];
